<script lang='ts'>
	export let starCount = 50;
	export let tailColor = "#ffffff";
</script>

<div class='container'>
	<div class='stars' style='--primary-color: {tailColor}'>
		{#each {length: starCount} as _, idx}
			<div class='star' data-index={idx}></div>
		{/each}
	</div>
</div>
